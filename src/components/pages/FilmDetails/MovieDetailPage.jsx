...
export default function MovieDetailPage() {
    ...
    return (
        <div className="flex-1 bg-white dark:bg-slate-950 text-slate-900 dark:text-white overflow-y-auto max-w-screen-xl mx-auto px-2 sm:px-4 md:px-8 rounded-md">
            {/* Backdrop */}
            <motion.div
