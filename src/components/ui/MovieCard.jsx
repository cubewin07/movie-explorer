    ...
    return (
        <div
            ...
            className="group flex gap-4 items-start cursor-pointer 
                ...
                hover:shadow-md dark:hover:shadow-blue-900/40"
        >
            <div className="relative w-16 h-24 flex-shrink-0">
                <img
                    ...
                    className="w-full h-full object-cover rounded-lg 
                        ...
                        group-hover:shadow-lg transition-transform duration-300 
                        group-hover:scale-105"
                />
                {rating && (
                    <div className="absolute -top-2 -right-2 bg-gradient-to-r from-amber-400 to-orange-500 text-white px-2 py-1 rounded-full text-xs font-semibold flex items-center shadow-md">
